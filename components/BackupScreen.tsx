    ...
    <div className="flex flex-col min-h-screen bg-slate-950 text-white no-scrollbar">
      <div className="bg-slate-900 shadow-lg z-30 border-b border-slate-800">
        <div className="max-w-xl mx-auto px-5 py-3 flex items-center gap-2">
          ...
          <h1 className="text-lg font-black uppercase tracking-wider">Seguridad</h1>
        </div>
      </div>
      <div className="flex-1 w-full max-w-xl mx-auto p-5 space-y-6">
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 text-center shadow-xl">
            <Download className="mx-auto text-blue-500 mb-4" size={40} />
            <button onClick={exportData} disabled={loading} className="w-full bg-blue-600 py-4 rounded-2xl font-black uppercase tracking-widest active:scale-95 transition-all">Generar Backup</button>
        </div>
