      ...
      <div className="bg-slate-950/95 p-4 border-b border-slate-900">
        <div className="max-w-xl mx-auto space-y-4">
          <div className="relative">
            ...
            <input value={search} onChange={e => setSearch(e.target.value)} className="w-full bg-slate-900 border border-slate-800 p-3 pl-10 rounded-xl text-xs font-black uppercase text-white outline-none focus:border-blue-500 transition-all" placeholder="BUSCAR..." />
          </div>
          ...
          {loading ? (
            ...
            <div key={r.id} className="bg-slate-900 border border-slate-800 p-4 rounded-3xl flex flex-col gap-3 shadow-sm">
              <div className="flex justify-between items-start">
                ...
                <span className="text-[9px] font-black uppercase px-2 py-1 bg-slate-800 rounded-lg border border-slate-700 text-slate-400">
                  {r.status}
                </span>
              </div>
            </div>
